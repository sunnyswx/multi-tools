...
const translations = {
  en: {
    ...
    'shadow.vertical_offset': 'Vertical Offset',
    'shadow.blur_radius': 'Blur Radius',
    'shadow.spread_radius': 'Spread Radius',
    'shadow.color': 'Color',
    'shadow.inset': 'Inset (Inner Shadow)',
    'shadow.reset': 'Reset',
  ...
  zh: {
    ...
    'shadow.vertical_offset': '垂直偏移',
    'shadow.blur_radius': '模糊半径',
    'shadow.spread_radius': '扩展半径',
    'shadow.color': '颜色',
    'shadow.inset': '内阴影',
    'shadow.reset': '重置',
    'shadow.random': '随机',
  ...
  ja: {
    ...
    'shadow.vertical_offset': '垂直オフセット',
    'shadow.blur_radius': 'ぼかし半径',
    'shadow.spread_radius': '拡がり半径',
    'shadow.color': '色',
    'shadow.inset': 'インセット（内側シャドウ）',
    'shadow.reset': 'リセット',
    'shadow.random': 'ランダム',
  ...
  ko: {
    ...
    'direction': '방향',
    'to_top': '위쪽',
    'to_bottom_right': '오른쪽 아래',
    'to_bottom': '아래쪽',
    'to_bottom_left': '왼쪽 아래',
    'angle': '각도',
    'random': '랜덤',
    'copy_css': 'CSS 복사',
    'css_output': 'CSS 코드',
    ...
    'shadow.vertical_offset': '수직 오프셋',
    'shadow.blur_radius': '흐림 반지름',
    'shadow.spread_radius': '확산 반지름',
    'shadow.color': '색상',
    'shadow.inset': '안쪽 그림자',
    'shadow.reset': '초기화',
    'shadow.random': '랜덤',
    ...
    tools: {
      ...
      'gradient-generator': { name: '그라데이션 생성기', desc: '아름다운 CSS 그라데이션을 온라인으로 생성' },
  ...
  es: {
    ...
    'direction': 'Dirección',
    'to_top': 'Hacia arriba',
    'to_bottom_right': 'Hacia abajo a la derecha',
    'to_bottom': 'Hacia abajo',
    'to_bottom_left': 'Hacia abajo a la izquierda',
    'angle': 'Ángulo',
    'random': 'Aleatorio',
    'copy_css': 'Copiar CSS',
    ...
    'shadow.vertical_offset': 'Desplazamiento Vertical',
    'shadow.blur_radius': 'Radio de Difuminado',
    'shadow.spread_radius': 'Radio de Expansión',
    'shadow.color': 'Color',
    'shadow.inset': 'Interior (Sombra Interior)',
    'shadow.reset': 'Restablecer',
    ...
    tools: {
      ...
      'gradient-generator': { name: 'Generador de Degradados', desc: 'Crea hermosos degradados CSS en línea' },
  ...
  fr: {
    ...
    'direction': 'Direction',
    'to_top': 'Vers le haut',
    'to_bottom_right': 'Vers le bas à droite',
    'to_bottom': 'Vers le bas',
    'to_bottom_left': 'Vers le bas à gauche',
    'angle': 'Angle',
    'random': 'Aléatoire',
    'copy_css': 'Copier CSS',
    'css_output': 'Code CSS',
    ...
    tools: {
      ...
      'gradient-generator': { name: 'Générateur de Dégradés', desc: 'Créez de magnifiques dégradés CSS en ligne' },
  ...
  de: {
    ...
    'copy_rgb': 'RGB kopieren',
    'copy_hsl': 'HSL kopieren',
    'color1': 'Farbe 1',
    'color2': 'Farbe 2',
    'direction': 'Richtung',
    'to_top': 'Nach oben',
    'to_bottom_right': 'Nach unten rechts',
    'to_bottom': 'Nach unten',
    'to_bottom_left': 'Nach unten links',
    'angle': 'Winkel',
    'random': 'Zufällig',
    ...
    'shadow.vertical_offset': 'Vertikale Verschiebung',
    'shadow.blur_radius': 'Weichzeichnungsradius',
    'shadow.spread_radius': 'Ausbreitungsradius',
    'shadow.color': 'Farbe',
    'shadow.inset': 'Innen (Innenschatten)',
    'shadow.reset': 'Zurücksetzen',
    ...
    tools: {
      ...
      'gradient-generator': { name: 'Verlaufs-Generator', desc: 'Erstellen Sie wunderschöne CSS-Verläufe online' },
  ...
  ru: {
    ...
    'copy_rgb': 'Копировать RGB',
    'copy_hsl': 'Копировать HSL',
    'color1': 'Цвет 1',
    'color2': 'Цвет 2',
    'direction': 'Направление',
    'to_top': 'Вверх',
    'to_bottom_right': 'Вниз вправо',
    'to_bottom': 'Вниз',
    'to_bottom_left': 'Вниз влево',
    'angle': 'Угол',
    'random': 'Случайный',
    ...
    'shadow.vertical_offset': 'Вертикальный Сдвиг',
    'shadow.blur_radius': 'Радиус Размытия',
    'shadow.spread_radius': 'Радиус Растяжения',
    'shadow.color': 'Цвет',
    'shadow.inset': 'Внутренняя (Внутренняя Тень)',
    'shadow.reset': 'Сбросить',
    ...
    tools: {
      ...
      'gradient-generator': { name: 'Генератор Градиентов', desc: 'Создавайте красивые CSS градиенты онлайн' },
  ...
  ar: {
    ...
    'direction': 'الاتجاه',
    'to_top': 'لأعلى',
    'to_bottom_right': 'لأسفل يميناً',
    'to_bottom': 'لأسفل',
    'to_bottom_left': 'لأسفل يساراً',
    'angle': 'الزاوية',
    'random': 'عشوائي',
    'copy_css': 'نسخ CSS',
    'css_output': 'كود CSS',
    ...
    'shadow.vertical_offset': 'الإزاحة العمودية',
    'shadow.blur_radius': 'نصف قطر الضبابية',
    'shadow.spread_radius': 'نصف قطر الانتشار',
    'shadow.color': 'اللون',
    'shadow.inset': 'داخلي (ظل داخلي)',
    'shadow.reset': 'إعادة تعيين',
    ...
    tools: {
      ...
      'gradient-generator': { name: 'مولد التدرجات', desc: 'أنشئ تدرجات CSS جميلة عبر الإنترنت' },
